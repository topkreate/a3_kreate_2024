...
namespace KreateWebsites
{
   ...
   public static int GetImageFullUrl(string imagepath, string imageurl, string thumbnail_path, ref string imagefullurl, ref string thumbnailurl)
 {
     ...
     if (imageurl.Contains("http://") || imageurl.Contains("https://") )
     {
        ...
        // Apr 2024
        thumbnailurl = imagefullurl;

         Generate.kreatelog("in if : " + imagepath + "," + imageurl + "," + thumbnail_path + "," + imagefullurl + "," + thumbnailurl);
     ...
     //Jan 2016    thumbnailurl = imagepath + thumbnail_path + imageurl;
         ...
         Generate.kreatelog("in else : " + imagepath + "," + imageurl + "," + thumbnail_path + "," + imagefullurl + "," + thumbnailurl);
       ...
       //         RepDetails.DataSource = dt;
        ...
        public static string GetImageName(string imageurl)
        {
            ...
            KreateWebsites.Generate.kreatelog("GetImageName = " + imageurl);
            ...
            */
            KreateWebsites.Generate.kreatelog("GetImageName return= " + url);
            return url;
        }

        public static string GetImageTitle(string imageurl)
        {
            // int lastSlashIndex = -1;
            if (imageurl.StartsWith("https://"))
            {
