            ...
            int i = 0;
              ...
              if (File.Exists(articlefile))
              {
                  ...
                  while ((url = file.ReadLine()) != null)
                  {
                    ...
                    //15 Apr 2024
                    Generate.kreatelog("name to display  " + name);
                    name = Generate.GetNameFromUrl(name);
                    // 15 Apr 2024 end
                   ...
                   Generate.kreatelog("Imagefullurl " + imagefullurl);
                      ...
                      // Sep2023 navigateurl2 = navigateurl; // dec 2021.  uncomment this. it will use photoviewer.php etc
