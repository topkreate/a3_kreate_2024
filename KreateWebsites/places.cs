...
WHEN 5 THEN ct.rank3  */
        ...
        public static DataTable GetTouristCategory(string continent, string country, string state, string statename, string city, string category, string subcategory, int n, int sortOrder, int direction, int spin)
        {


               string sp = "best_tourist_places_category_search";
    ...
    //    Response.Write ("In category " + continent + "," + country + ","  + state + "," + statename + "," + city  + "," + category +  "," + subcategory +  ","+  "<br/>");
        using (SqlConnection conn = new SqlConnection(connect))
        {
