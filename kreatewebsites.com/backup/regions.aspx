...
<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="regions.aspx.cs" Inherits="Default" CodeFileBaseClass="BasePage" 
     %>
...
<h2>
     <asp:HyperLink ID="HyperLink1" runat="server" Text='<%#Eval("region")%>'                                          
...
<p>
    ...
    <asp:HyperLink ID="HyperLink4" runat="server" Text='<%#Eval("country")%>'                                          
