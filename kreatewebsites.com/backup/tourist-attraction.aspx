...
<%@ Page Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="tourist-attraction.aspx.cs" Inherits="Default" 
...
<asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl='<%# DataBinder.Eval(Container.DataItem, "biz_name", "https://www.kreatewebsites.com/tourist-attraction.aspx?name={0}") %>' class="readmore"><span>See More pictures</span></asp:HyperLink> 
