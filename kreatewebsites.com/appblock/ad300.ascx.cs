    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        switch(Global.adID)
        {
            ...
            case 102:
                ...
                break;
            case 103:
                adscript = System.IO.File.ReadAllText(@"c:\e\a3_input\sankranti.net\input\ad300text.ad");

                break;
            case 104:
                adscript = System.IO.File.ReadAllText(@"c:\e\a3_input\makarsankranti.org\input\ad300text.ad");
