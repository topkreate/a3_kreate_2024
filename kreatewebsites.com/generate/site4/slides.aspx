<%@ Page Language="C#" MasterPageFile="MasterPage_header2023.master" AutoEventWireup="true" CodeFile="~/slides.aspx.cs" Inherits="Photos" 
Title="slides"  CodeFileBaseClass="BasePage"  %>
							...
							<!-- Content -->
									...
									<article class="is-page-content">
										<span class="byline"> <asp:Label ID="metadesc" runat="server" ></asp:Label></span>
                                             ...
                                             <h2><asp:label runat="server" ID="title2"></asp:label></h2>
