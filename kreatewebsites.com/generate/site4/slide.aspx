<%@ Page Language="C#" MasterPageFile="MasterPage_header2023.master" AutoEventWireup="true" CodeFile="~/slide.aspx.cs" Inherits="Photo" Title="slide"
    ...
    <header id="header">
				<div class="logo">
					<div>
						...
						<span class="byline"><asp:label runat="server" ID="title"></asp:label></span>
					</div>
			</header>
