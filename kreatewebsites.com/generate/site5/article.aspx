						...
						<div class="8u mobileUI-main-content">
							...
							<!-- Content -->
								<div id="content">
									...
									<asp:hyperlink ID="buttonmain"  runat="server" class="button" >  Button Main           </asp:hyperlink>
                                                            <asp:hyperlink ID="buttonall"  runat="server" class="button button-alt" >  Button all           </asp:hyperlink>												
										</article>
								</div>
