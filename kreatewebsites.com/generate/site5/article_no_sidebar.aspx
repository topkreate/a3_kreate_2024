...
<%@ Page Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="article_no_sidebar.aspx.cs" Inherits="Article" 
						...
						<div class="12u mobileUI-main-content">
							...
							<!-- Content -->
								<div id="content">
									...
									<asp:hyperlink ID="buttonmain"  runat="server" class="button" >  Button No sidebar          </asp:hyperlink>
                                                            <asp:hyperlink ID="buttonall"  runat="server" class="button button-alt" >  Button sidebar           </asp:hyperlink>												
										</article>
								</div>
