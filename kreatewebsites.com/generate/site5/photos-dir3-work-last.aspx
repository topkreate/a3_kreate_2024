<%@ Page Language="C#" MasterPageFile="MasterPage2023-main.master" AutoEventWireup="true" CodeFile="~/photos-dir.aspx.cs" Inherits="Photos" 
...
<ItemTemplate>
	   ...
	   <div class ="inner"><asp:Hyperlink ID="hyperlink1" runat="server"  Text='<%# Eval("displayname")  %>'  NavigateUrl='<%#  Eval("Navigateurl") %>' />    </div>
