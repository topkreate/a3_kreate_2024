<%@ Page Language="C#" MasterPageFile="MasterPage-6-1.master" AutoEventWireup="true"  CodeFile="~/photos-dir.aspx.cs" Inherits="Photos" 
		...
		<asp:Datalist ID="RepDetails" runat="server"  RepeatColumns="4" RepeatDirection="Horizontal"  >
               <HeaderTemplate>
                                ...
                                <ItemTemplate>
                                    ...
                                    <section>
                                          <header>
                                              <h3> <asp:Hyperlink ID="hyperlink1" runat="server"   Text='<%# Eval("displayname")  %>'  NavigateUrl='<%#  Eval("Navigateurl2") %>' /></h3>
                                          </header>
                                         ...
                                         <blockquote>  <asp:Hyperlink ID="hyperlink2" runat="server"  Text='<%# Eval("displayname")  %>'  NavigateUrl='<%#  Eval("Navigateurl") %>' /></blockquote>
