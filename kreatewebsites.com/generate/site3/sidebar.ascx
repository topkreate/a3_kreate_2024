<%@ Control Language="C#" AutoEventWireup="true" CodeFile="sidebar.ascx.cs" Inherits="sidebar" %>
	...
	<%@ Register Src="~/appblock/ad300.ascx" TagName="ad300" TagPrefix="ucl" %>
	<%@ Register Src="~/appblock/ad250.ascx" TagName="ad250" TagPrefix="ucl" %>
							...
							<!-- Sidebar 1 -->
								...
								<section>
									...
									<p>
                                        ...
                                        <ucl:ad300 ID="ad300" runat="server"/>
							...
							<!-- Sidebar 2 -->
								...
								<section>
									...
									<p>
                                         ...
                                         <ucl:ad250 ID="ad250" runat="server"/>				
									</p>
                                    <h3>Main Topic</h3>
									<ul class="link-list">
