...
<%@ Page Language="C#" MasterPageFile="ace-masterpage.master" AutoEventWireup="true"  codeFile="~/photos-dir.aspx.cs" Inherits="Photos"  Title="KreateWebsites"  CodeFileBaseClass="BasePage"  %>
    ...
    <div class="container py-5">
        <div class="row g-5 align-items-center">
            <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
                <h1 class="display-3 text-white animated slideInDown mb-4"><asp:label runat="server" ID="title"></asp:label></h1>
