<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="generate_articles_subdomain.aspx.cs" Inherits="Generate" CodeFileBaseClass="BasePage" 
 ...
 <form runat="server">
  ...
  Output Path = <asp:textbox ID="textbox_outputpath" runat="server"></asp:textbox> <br />
     ...
     Overwrite = <asp:textbox ID="check_overwrite" runat="server"></asp:textbox> 
       AD = <asp:textbox ID="textbox_Ad" runat="server"></asp:textbox> 
